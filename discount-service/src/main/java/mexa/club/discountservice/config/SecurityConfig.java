...
import mexa.club.discountservice.security.JwtRequestFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtRequestFilter jwtRequestFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/internal/discounts/**").permitAll()
                        .requestMatchers("/api/admin/promotions/**").hasAuthority("DISCOUNT_MANAGE")
